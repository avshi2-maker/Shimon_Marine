...
const PRESETS: PresetMeta[] = [
  { key: 'port',    label: 'נמל · גובה גל 0', sub: '22 t · DAF 1.15' },
  { key: 'open',    label: 'ים פתוח',         sub: '22 t · DAF 1.30' },
  { key: 'inshore', label: 'מוגן · קל',       sub: '16.4 t · DAF 1.15' },
  { key: 'static',  label: 'יבשתי סטטי',      sub: '22 t · DAF 1.00' },
];
